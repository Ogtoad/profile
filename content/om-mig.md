---
title: Om mig
subtitle: Tillämpad AI med djup och bredd
description: AI-konsult med fokus på tillämpad matematik, systemarkitektur och tvärvetenskapligt tänkande.
---
...
En tid smög jag in i kryptografi och tillämpade matematiska metoder för att lösa chiffer. Det gav insikter inom NLP: båda berör stokastisk distribuering av information och beräkningskomplexitet. Att lösa ett substitutionschiffer är inte helt olikt encoding-decoding av ord när man arbetar med språkmodeller.

Även mitt estetiska intresse för grafisk design har visat sig värdefullt. Med det följde en geometrisk förståelse för proportioner och dimensionell rymd – matematiska samband som är direkt tillämpbara inom computer vision, men också för att skapa gränssnitt som faktiskt fungerar.
...
- **Backend**: Django, FastAPI eller Flask beroende på uppdrag.
...
Problem utan uppenbara lösningar är det som allra främst driver mig. Jag trivs med att finna lösningar genom okonventionella metoder och tankesätt som leder till nya insikter om problemdomänen. Därför platsar jag bäst inom R&D, där jag får jobba med edge-cases och problemdomäner som ännu saknar både namn och formuleringar.
